...
// global variables
#define MAX_RECORD_COUNT 10485760

volatile LONG        gRecordIndex = -1;

LARGE_INTEGER* gTimeStampArray = NULL;
HANDLE* gProcessIdArray = NULL;
LARGE_INTEGER* gFileSizeArray = NULL;
UINT8* gIsReadArray = NULL;
UINT8* gIsWriteArray = NULL;
UINT8* gIsRenameArray = NULL;
UINT8* gIsDeleteArray = NULL;

#define FILE_SUFFIX_LEN    15
#define FILE_SUFFIX_BUFFER (FILE_SUFFIX_LEN + 1)
WCHAR(*gFileNameSuffix)[FILE_SUFFIX_BUFFER] = NULL;
